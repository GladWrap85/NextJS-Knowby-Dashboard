...
export default function TopMetricsRow({ selectedDateRange }: Props) {
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-5 gap-6">
      {/* Active Members */}
      <Card className="flex flex-row items-center p-4 bg-card shadow-xl/2 gap-3 border-0 border-b-teal-500/50 border-b-2 rounded-3xl">
      ...
      {/* Knowbys */}
      <Card className="flex flex-row items-center p-4 bg-card shadow-xl/2 gap-3 border-0 border-b-indigo-500/50 border-b-2 rounded-3xl">
      ...
      {/* Views */}
      <Card className="flex flex-row items-center p-4 bg-card shadow-xl/2 gap-3 border-0 border-b-blue-500/50 border-b-2 rounded-3xl">
      ...
      {/* Completions */}
      <Card className="flex flex-row items-center p-4 bg-card shadow-xl/2 gap-3 border-0 border-b-green-500/50 border-b-2 rounded-3xl">
      ...
      {/* Completion Rate */}
      <Card className="flex flex-row items-center p-4 bg-card shadow-xl/2 gap-3 border-0 border-b-purple-500/50 border-b-2 rounded-3xl">
